...
class UserController extends Controller
{
    ...
    public function actionResetPassword($id){
        ...
        if($user->save()){
            Yii::$app->session->setFlash('success', 'Password reset successfuly');
        }else{
            Yii::$app->session->setFlash('error', 'Failed to reset successfuly');
        }
    ...
    protected function findModel($id){
        ...
        throw new NotFoundHttpException('The resquested page does not exist.');
    }
